...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
    ...
    //..loadRequest(Uri.parse('https://campusplus.um6p.ma/mazmap/app.html'));
    //..loadRequest(Uri.parse('https://use.mazemap.com/#v=1&config=mazemap-hq&zlevel=6&center=10.407469,63.432882&zoom=19.5&campusid=47'));
      ..loadRequest(Uri.parse('https://map.alhaouz.org/'));
